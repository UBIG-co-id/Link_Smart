...
import { kenaikanKelas } from '../../component/user/UserData'
...
const KenaikanKelas = () => {
  ...
  const [data, setData] = useState(kenaikanKelas);
...
const onActionClick = (e) => {
  ...
  return (
    <React.Fragment>
      <Head title="Kenaikan Kelas"></Head>
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
                ...
                ? currentItems.map((item) => {
                  return (
                    <DataTableItem key={item.id}>
                      ...
                      <DataTableRow>
                        <span
                          className={`tb-status text-${item.kenaikan === "Naik Kelas" ? "success" : item.kenaikan === "Tinggal" ? "danger" : ""
                            }`}
                        >
                          {item.kenaikan}
                        </span>
