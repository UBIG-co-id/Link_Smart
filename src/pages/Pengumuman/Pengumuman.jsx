...
import { pengumuman } from '../../component/user/UserData'
...
const Pengumuman = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const apiUrl = `https://linksmart-1-t2560421.deta.app/pengumuman-cari?${queryString}`;
                                    ...
                                    <ul className="nk-block-tools g-3">
                                        <li>
                                            <Button color="primary" outline className="btn-dim btn-white">
                                                ...
                                                <span>Kirim Pengumuman Rapor</span>
                                            </Button>
                                        </li>
                                        {/* <li>
                                            <Button color="primary" outline className="btn-dim btn-white">
                        ...
                        <div className="card-inner">
                            <div className="card-title-group">
                                <div className="card-title">
                                    <h5 className="title">Data Pengumuman</h5>
                                </div>
                                ...
                                ? currentItems.map((item) => {
                                    return (
                                        <DataTableItem key={item.id}>
                                            ...
                                            <DataTableRow>
                                                <div className="tb-lead">
                                                    <span>{item.website ? 'ya' : 'tidak'}</span>
                                                </div>
                                            </DataTableRow>
