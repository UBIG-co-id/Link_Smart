...
const TampilanRapor = () => {
    ...
    const [data, setData] = useState(tampilkanRapor);
    ...
    return (
        <React.Fragment>
            <Head title="Tampilkan Rapor"></Head>
            <Content>
                <BlockHead size="sm">
                    <BlockBetween>
                        <BlockHeadContent>
                    ...
                    <DataTable className="card-stretch">
                        ...
                        <DataTableBody bodyclass="nk-tb-tnx">
                            <DataTableHead>
                                ...
                                <DataTableRow >
                                    <span>Tampilkan Rapor</span>
                                </DataTableRow>
                                <DataTableRow className="nk-tb-col-tools">Pilih</DataTableRow>
                            </DataTableHead>
