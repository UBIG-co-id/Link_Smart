...
const PresensiPegawai = () => {
  ...
  return (
    <React.Fragment>
    <Head title="Laporan Presensi Pegawai" />
    <Content>
        <BlockHead size="sm">
            <BlockBetween>
                <BlockHeadContent>
                    <BlockTitle page>Laporan Presensi Pegawai</BlockTitle>
                    ...
                    <PreviewAltCard className="card-full">
                        ...
                        <Col md='12' >
                            <div className="form-group" style={{ marginTop: '21px' }}>
                                <label className="form-label">Lewati Hari Libur</label>
                                <RSelect
