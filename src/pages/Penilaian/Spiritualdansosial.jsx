...
const Spiritualdansosial = () => {
    ...
    return (
        <React.Fragment>
            <Head title="Penilaian Spiritual dan Sosial" />
            <Content>
                <BlockHead size="sm">
                    <BlockBetween>
                        <BlockHeadContent>
                            <BlockTitle page>Penilaian Spiritual dan Sosial</BlockTitle>
...
export default Spiritualdansosial
