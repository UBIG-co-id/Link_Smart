...
const Keterampilan = () => {
    ...
    return (
        <React.Fragment>
            <Head title="Penilaian Keterampilan" />
            <Content>
                <BlockHead size="sm">
                    <BlockBetween>
                        <BlockHeadContent>
                            <BlockTitle page>Penilaian Keterampilan</BlockTitle>
                ...
                <Block>
                    <Row className="g-gs">
                        ...
                        <PreviewAltCard className="card-full">
                            ...
                            <br />
                            <div className='form-group' style={{ height: "100px", display: "flex", justifyContent: "center", alignItems: "center" }}>
